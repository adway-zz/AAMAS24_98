function [x conc p1] = dir_posterior_SPM(Y,N,S,K,alpha0, Nfr,Sfr,num_cands,num_samps)
...
% conc: list of SPM concentrations for each candidate solution
...
conc(i)=0.9+0.1*rand;
for j=1:num_samps
[CC{i}{j} V{i}(j,:)] = SPM_batch(N,S,100,x(i,:),conc(i));
