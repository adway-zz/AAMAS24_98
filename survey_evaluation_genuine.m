function [Yt LR] = survey_evaluation_genuine(Z0,X0, N,S,K,alpha0,thres,Nfr,Sfr)
...
y21=0.99*Yt{j}(1,:)+0.01*(1/K)*ones(1,K);
y22=0.99*Yt{j}(2,:)+0.01*(1/K)*ones(1,K);
...
y21=0.99*Yt{j}(1,:)+0.01*(1/K)*ones(1,K);
y22=0.99*Yt{j}(2,:)+0.01*(1/3)*ones(1,K);
